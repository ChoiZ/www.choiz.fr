...
![Schéma : master sur C, debug_redirect sur A](/images/git-branch-1.svg)
...
![Schéma : master et debug_redirect sur C](/images/git-branch-2.svg)
...
![Schéma : master sur A, debug_redirect sur C](/images/git-branch-3.svg)
...
![Schéma : merge no-ff, D fusionne C sur master](/images/git-branch-4.svg)
